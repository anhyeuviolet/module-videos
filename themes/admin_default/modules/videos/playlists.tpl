			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						&nbsp; <span class="text-middle"><em class="fa fa-refresh fa-lg fa-pointer" onclick="get_alias('playlists', {DATA.playlist_id});">&nbsp;</em></span>
					</td>
				</tr>
				<tr>
					<td class="text-right"><strong>{LANG.content_homeimg}:</strong></td>
					<td><input class="form-control pull-left w500" style="margin-right: 5px" type="text" name="homeimg" id="homeimg" value="{DATA.image}" /> <input id="select-img-playlist" type="button" value="Browse server" name="selectimg" class="btn btn-info" /></td>
				</tr>
				<tr>
...
$("#idtitle").change(function() {
	get_alias('playlists', '{DATA.playlist_id}');
});
<!-- END: getalias -->
</script>
<!-- END: main -->