window.jwplayer = function(e) {
    ...
    function c() {
        return w.html5 = !0, n.e(0).then(function(e) {
            n(9);
            var t = n(3).default;
            return g.b.controls = n(2).default, Object(m.a)(n(11).default), t
        }.bind(null, n)).catch(i)
    }
    ...
    function i(e) {
        ...
        var n = !0;
        return e.mediaTypes && (n = p.a.all(e.mediaTypes, function(e) {
    ...
    var r = "8.0.11+commercial_v8-0-11.221.commercial.8cc5fe.hlsjs..jwplayer.2df85c.dai.c13f11.freewheel.01885d.googima.534335.vast.5ded3a.jwpsrv.32f990.gapro.fb7ea6.related.eac442.vr.2cfb26"
}, function(e, t, n) {
    "use strict";
    ...
    function o(e, t) {
        var n = e.sources,
            ...
            o = t.get("safarihlsjs"),
            a = e.drm || t.get("drm"),
            u = c(e.withCredentials, t.get("withCredentials")),
            s = !1 !== t.get("hlsjsdefault");
        return n.map(function(t) {
            if (t !== Object(t)) return null;
            void 0 !== i && null !== i && (t.androidhls = i), void 0 !== o && null !== o && (t.safarihlsjs = o), (t.drm || a) && (t.drm = t.drm || a), t.preload = r(t.preload, e.preload);
            var n = c(t.withCredentials, u);
            return void 0 !== n && (t.withCredentials = n), s && (t.hlsjsdefault = s), Object(f.a)(t)
        }).filter(function(e) {
            return !!e
        })
    }
    ...
    function u(e) {
        var t = "file:" === window.location.protocol ? "https:" : "",
            n = {
                jwpsrv: jw_lib_location + "jwpsrv.js",
                dai: jw_lib_location + "dai.js",
                vast: jw_lib_location + "vast.js",
                googima: jw_lib_location + "googima.js",
                freewheel: jw_lib_location + "freewheel.js",
                related: jw_lib_location + "related.js",
                gapro: jw_lib_location + "gapro.js",
                vr: jw_lib_location + "vr.js"
            },
            r = n[e];
        return r ? t + r : ""
    }
    ...
    function l(e) {
        ...
        return "string" == typeof t ? new F.a(function(n) {
            ...
            r.on(A.U, function(t) {
                ...
                e.attributes.playlist = [], e.set("feedData", {
        ...
        return l(e).then(function() {
            if (!v(e)) {
                ...
                var t = e.get("playlist"),
                    n = e.getProviders(),
                    r = n.required([t[0]]);
                if (!q.a.html5 || !r || "html5" !== r[0].name) return n.load(r)
            }
        })
    }
    ...
    function h(e) {
        return l(e).then(function() {
            return e.get("drm") || Object(Q.b)(e.get("playlist")) ? Object(Q.d)(e.get("edition")) : F.b
        })
    }
    ...
    re(oe.prototype, {
        ...
        init: function(e, t) {
            ...
            return re(r.attributes, a, Z.a), r.getProviders = function() {
                return new H.a(a)
            }, r.setProvider = function() {}, (r.attributes.mediaElement = Object(ne.a)(this.originalContainer)).load(), F.a.all([Object(q.c)(r), this.setup.start(), Object(W.a)(r, t)]).then(function(e) {
                var r = e[0];
                if (n.setup) {
    ...
    var E = P,
        ...
        F = k.a.extend,
        I = {};
    I.api = v, I._ = k.a, I.version = "8.0.11+commercial_v8-0-11.221.commercial.8cc5fe.hlsjs..jwplayer.2df85c.dai.c13f11.freewheel.01885d.googima.534335.vast.5ded3a.jwpsrv.32f990.gapro.fb7ea6.related.eac442.vr.2cfb26", I.utils = A(O.a, {
        key: T.a,
        extend: F,
        scriptloader: _.a,
        rssparser: {
    ...
    var R = I,
        ...
        q = window;
    B(E, R), "function" == typeof q.define && q.define.amd && q.define([], function() {
        return E
    });
    var D = E;
