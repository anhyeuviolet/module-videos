...
<!-- END: error -->
<div class="row">
	<form action="{CONTENT_URL}" name="fsea" method="post" id="fsea" class="form-horizontal col-xs-24 col-sm-24 col-md-24 col-lg-24">
		...
		<div class="form-group">
			...
			<div class="col-sm-20">
				<input type="text" class="form-control pull-left" name="alias" id="idalias" value="{DATA.alias}" maxlength="255" style="width: 92%;" />
		...
		<div class="form-group">
			...
			<div class="col-sm-20">
				<input class="form-control" type="text" name="vid_path" id="vid_path" placeholder="{LANG.videos_sources_placeholder}" value="{DATA.vid_path}"/>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="col-sm-24">{LANG.content_hometext}</label>
			<div class="col-sm-24 col-xs-24 col-lg-24 col-md-24">
				<textarea class="form-control" rows="6" cols="60" name="hometext"> {DATA.hometext}</textarea>
			</div>
		</div>

		<div class="form-group row">
			<label class="col-sm-24">{LANG.content_bodytext}</label>
			<div class="col-sm-24 col-xs-24 col-lg-24 col-md-24">
				{HTMLBODYTEXT}
			</div>
		</div>
